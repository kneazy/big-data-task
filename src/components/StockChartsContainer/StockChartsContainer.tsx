...
import { stockHistoryDataState } from '../../store/redusers/stockHistory';
...
export const StockChartsContainer: FC = () => {
  const stockHistory = useSelector<ReduxProps, stockHistoryDataState>((state) => state.stockHistoryData);
